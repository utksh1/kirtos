...
const TEST_CASES = [
    ...
    { text: "play some jazz", expected: "browser.play_youtube" }, // Guard should catch "jazz"
    ...
    { text: "hey kirtos define black hole", expected: "knowledge.define" }, // "hey kirtos" is not stripped yet, let's see
];
