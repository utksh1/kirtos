...
for (let i = 0; i < ITERATIONS; i++) {
    ...
    try {
        ...
        // Property 1: No Crashes (Already handled by try/catch)
        // Property 2: PolicyEngine never allows unknown intents
        ...
        // Property 3: Canonicalizer removes invisible chars (checked via trace)
