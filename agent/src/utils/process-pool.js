...
class WarmProcess {
    ...
    async run(input) {
        ...
        return new Promise((resolve, reject) => {
            ...
            // a real one would need a delimiter to know when a command finishes.
            // For now, we'll use this for simple shell commands where we can append an echo delimiter.
