...
/**
 * Input Domain Configuration (Phase 2)
 * Native mouse control via CGEvent helper process.
 * All actions are HIGH risk and require ui.pointer.control permission.
 */
module.exports = {
    name: 'input',
    version: '0.1.0',
    ...
    intents: {
        /**
         * input.mouse.move — Move the mouse cursor to absolute screen coordinates.
         * Risk: HIGH.
         */
        'mouse.move': {
        ...
        /**
         * input.mouse.click — Click at absolute screen coordinates.
         * Risk: HIGH.
         */
        'mouse.click': {
        ...
        /**
         * input.mouse.scroll — Scroll the mouse wheel.
         * Risk: HIGH.
         */
        'mouse.scroll': {
        ...
        /**
         * input.mouse.drag — Drag from one point to another.
         * Risk: HIGH.
         */
        'mouse.drag': {
