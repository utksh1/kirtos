...
// Intent Allowlist Definition
// Authoritative source: docs/06-intents-allowlist.md
...
const Intents = {
    ...
    'chat.message': {
        ...
        permissions: ['system.read'], // Chat is always allowed
        risk: 'low',
        runtime: 'chat'
    },
    'system.uptime': {
    ...
    'network.ping': {
        ...
        risk: 'high',
        runtime: 'code' // As per docs, mapped to code runtime? Or maybe system. Docs said 'code' for runtime in table step 8.
        // doc says: network.* -> code. 
    },
    'network.scan': {
        schema: z.object({
            target: z.string().min(1)
    ...
    // System Settings Intents (Structured macOS Control)
