...
const FRAG_SHADER = `
    ...
    vec4 mainImage(vec2 fragCoord, float iTime, float hue, float rot, vec3 iResolution, float hover, float hoverIntensity) {
      ...
      return draw(uv, iTime, hue);
    }

    void main() {
      vec2 fragCoord = vUv * iResolution.xy;
      vec4 col = mainImage(fragCoord, iTime, hue, rot, iResolution, hover, hoverIntensity);
